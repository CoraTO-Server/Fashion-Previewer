...
if not exist "fashionpreviewer_v2.0.py" (
    echo ERROR: fashionpreviewer_v2.0.py not found!
    echo Make sure this batch file is in the same folder as fashionpreviewer_v2.0.py
    pause
    exit /b 1
)
